<template>
  <div class="recommend">
    ...
    <ul class="tab-bd">
      <li v-for="(tabBody, index) in recommend.tabBody[tabIndex]"
        :key="tabBody.id"
        ...
        <a v-if="!tabBody.class" :href="tabBody.href" target="_blank">
          ...
          <div class="hover">
            ...
            <div class="find">
              <div @click.prevent="loadMore" class="find-btn">
...
function deleteItem(index){
  //替换数据
  //recommend.tabBody[tabIndex.value][index] = 
}
</script>
